...
def update(db, limit, summonerName=None, summonerId=None):
  """
  ...
  """
  if summonerName:
    summoner = db["summoners"].find_one({"internalName": makeInternalName(summonerName)})  
  elif summonerId:
...
def findRecentMatchIds(db, summonerMatches, startIdx=0, size=30, no_limit=False):
  """
